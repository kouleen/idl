...
var RegisterRequest_Gender_DEFAULT int8

func (p *RegisterRequest) GetGender() (v int8) {
	if !p.IsSetGender() {
		return RegisterRequest_Gender_DEFAULT
	}
	return *p.Gender
}
...
func (p *RegisterRequest) SetGender(val *int8) {
	p.Gender = val
}
...
func (p *RegisterRequest) IsSetGender() bool {
	return p.Gender != nil
}
